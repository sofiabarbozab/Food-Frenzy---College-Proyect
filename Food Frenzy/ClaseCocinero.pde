class Cocinero{
  ...
  Cocinero(){
    ...
    neutralSinPlato_Atras_Inmovil = loadImage("neutralSinPlato_Atrás_Inmóvil.png");
    ...
    neutralSinPlato_Izquierda_Inmovil = loadImage("neutralSinPlato_Izquierda_Inmóvil.png");
    ...
    neutralSinPlato_Derecha_Inmovil = loadImage("neutralSinPlato_Derecha_Inmóvil.png");
    ...
    neutralLlevandoPlato_Atras_Inmovil = loadImage("neutralLlevandoPlato_Atrás_Inmóvil.png");
    ...
    neutralLlevandoPlato_Frente_Inmovil = loadImage("neutralLlevandoPlato_Frente_Inmóvil.png");
    ...
    neutralLlevandoPlato_Izquierda_Inmovil = loadImage("neutralLlevandoPlato_Izquierda_Inmóvil.png");
    ...
    neutralLlevandoPlato_Derecha_Inmovil = loadImage("neutralLlevandoPlato_Derecha_Inmóvil.png");
    ...
    nerviosoSinPlato_Atras_Inmovil = loadImage("nerviosoSinPlato_Atrás_Inmóvil.png");
    ...
    nerviosoSinPlato_Frente_Inmovil = loadImage("nerviosoSinPlato_Frente_Inmóvil.png");
    ...
    nerviosoSinPlato_Izquierda_Inmovil = loadImage("nerviosoSinPlato_Izquierda_Inmóvil.png");
    ...
    nerviosoSinPlato_Derecha_Inmovil = loadImage("nerviosoSinPlato_Derecha_Inmóvil.png");
    ...
    nerviosoLlevandoPlato_Atras_Inmovil = loadImage("nerviosoLlevandoPlato_Atrás_Inmóvil.png");
    ...
    nerviosoLlevandoPlato_Frente_Inmovil = loadImage("nerviosoLlevandoPlato_Frente_Inmóvil.png");
    ...
    nerviosoLlevandoPlato_Izquierda_Inmovil = loadImage("nerviosoLlevandoPlato_Izquierda_Inmóvil.png");
    ...
    nerviosoLlevandoPlato_Derecha_Inmovil = loadImage("nerviosoLlevandoPlato_Derecha_Inmóvil.png");
    x = width/2;
    y = height/2;
    velocidad =  4;
